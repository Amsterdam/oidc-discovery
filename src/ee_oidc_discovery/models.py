...
class OIDCProviderMetadata(BaseModel):
    ...
    scopes_supported: Optional[list[StrictStr]]
    ...
    response_modes_supported: Optional[list[StrictStr]]
    ...
    grant_types_supported: Optional[list[StrictStr]]
    ...
    acr_values_supported: Optional[list[StrictStr]]
    ...
    id_token_encryption_alg_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE encryption algorithms
    (alg values) supported by the OP for the ID Token to encode the Claims in a JWT
    [JWT]."""

    id_token_encryption_enc_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE encryption algorithms
    (enc values) supported by the OP for the ID Token to encode the Claims in a JWT
    [JWT]."""

    userinfo_signing_alg_values_supported: Optional[list[StrictStr]]
    ...
    userinfo_encryption_alg_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE [JWE] encryption algorithms
    (alg values) [JWA] supported by the UserInfo Endpoint to encode the Claims in a JWT
    [JWT]."""

    userinfo_encryption_enc_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE encryption algorithms
    (enc values) [JWA] supported by the UserInfo Endpoint to encode the Claims in a JWT
    [JWT]. """

    request_object_signing_alg_values_supported: Optional[list[StrictStr]]
    ...
    request_object_encryption_alg_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE encryption algorithms
    ...
    request_object_encryption_enc_values_supported: Optional[list[StrictStr]]
    """OPTIONAL. JSON array containing a list of the JWE encryption algorithms
    (enc values) supported by the OP for Request Objects. These algorithms are used
    both when the Request Object is passed by value and when it is passed by
    reference."""

    token_endpoint_auth_methods_supported: Optional[list[StrictStr]]
    ...
    token_endpoint_auth_signing_alg_values_supported: Optional[list[StrictStr]]
    ...
    display_values_supported: Optional[list[StrictStr]]
    ...
    claim_types_supported: Optional[list[StrictStr]]
    ...
    claims_supported: Optional[list[StrictStr]]
    ...
    claims_locales_supported: Optional[list[StrictStr]]
    ...
    ui_locales_supported: Optional[list[StrictStr]]
    ...
    claims_parameter_supported: Optional[StrictBool]
    ...
    request_parameter_supported: Optional[StrictBool]
    """OPTIONAL. Boolean value specifying whether the OP supports use of the request
    parameter, with true indicating support. If omitted, the default value is false."""

    request_uri_parameter_supported: Optional[StrictBool]
    ...
    require_request_uri_registration: Optional[StrictBool]
